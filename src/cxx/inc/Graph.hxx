...
#define GRAPH_SET_VALUES_SCAN(K, V, E, vvalues, eto) \
  GRAPH_SET_VERTEX_VALUE(K, V, E, vvalues) \
  GRAPH_SET_EDGE_VALUE_X(K, V, E, u, v, w, ft, if (ft(u)) eto[u].set(v, w),)
#endif
...
#define GRAPH_RESERVE_EDGES_SCAN(K, V, E, eto) \
  GRAPH_RESERVE_EDGES_X(K, V, E, u, deg, eto[u].reserve(deg),)
...
#define GRAPH_RESERVE_SCAN(K, V, E, vexists, vvalues, eto) \
  GRAPH_RESERVE_X(K, V, E, vexists, vvalues, n, deg, eto.resize(max(n, span())),)
#endif
...
#define GRAPH_UPDATE_EDGES_SCAN(K, V, E, eto) \
  GRAPH_UPDATE_EDGES_X(K, V, E, u, buf, eto[u].update(buf),)
...
#define GRAPH_RESPAN_SCAN(K, V, E, vexists, vvalues, eto) \
  GRAPH_RESPAN_X(K, V, E, vexists, vvalues, n, eto.resize(n),)
#endif
...
#define GRAPH_CLEAR_SCAN(K, V, E, N, M, vexists, vvalues, eto) \
  GRAPH_CLEAR_X(K, V, E, N, M, vexists, vvalues, eto.clear(),)
#endif
...
#define GRAPH_ADD_EDGE_SCAN(K, V, E, eto) \
  GRAPH_ADD_EDGE_X(K, V, E, u, v, w, ft, if (ft(u)) eto[u].add(v, w),)
#endif
...
#define GRAPH_REMOVE_EDGE_SCAN(K, V, E, eto) \
  GRAPH_REMOVE_EDGE_X(K, V, E, u, v, ft, if (ft(u)) eto[u].remove(v),)
#endif
